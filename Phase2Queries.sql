...
(Alex) At least 1 user defined function - this should not be a stored procedure, create your own function, don’t use a pre-defined function that is a stored procedure for this we make our own.   
...
Set the recovery model for your database as full recovery model. Take a full backup of your database.  **/
